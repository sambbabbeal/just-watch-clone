...
const TemplateCardSimple = (args) => { return <Card componentContained={<FakeCompo />} title="hello" />; }
const TemplateCardMovie = (args) => {
    return <Card componentContained={<FakeCompo3 imgUrl="https://www.filmspourenfants.net/wp-content/uploads/2018/07/retour-vers-le-futur-a-371x500.jpg" />} title="Retour vers le futur" />
...
const FakeCompo3 = ({ imgUrl }) => {
    return (<div className="imageContainer"><img src={imgUrl} /></div>)
}
...
MovieGridExempleCardCinema.args = { listMovie: [<Card componentContained={<FakeCompo3 imgUrl="https://static.fnac-static.com/multimedia/Images/FR/NR/11/c5/be/12502289/1507-1/tsp20210929142606/Retour-vers-le-futur-Toute-l-histoire-d-une-saga-culte.jpg" />} title="Retour vers le futur" />, <Card componentContained={<FakeCompo2 />} title="BYE" />] };